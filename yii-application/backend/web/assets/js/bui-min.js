...
define("bui/util", function() {
    ...
    $.extend(BUI, {
        ...
        isObject: r.call(null) === "[object Object]" ?
            function(e) {
    ...
    typeof r.stringify != "function" && (r.stringify = function(e, t, n) {
        var r;
        u = "", a = "";
        if (typeof n == "number") for (r = 0; r < n; r += 1) a += " ";
    ...
    function h(e) {
        var t = e.getAttrs(),
            r, s;
        for (r in t) t.hasOwnProperty(r) && (s = n + i(r), e[s] &&
        function(t, n) {
    ...
    var t = e("bui/common"),
        ...
        l = n.Controller.extend([r.ListItem, r.Collapseable], {
            ...
            _uiSetOpen: function(e) {
                ...
                if (n) if (e) r.node = t.get("el"), n.set("align", r), n.show();
                else {
                    var i = n.get("align");
    ...
    return d.ATTRS = {
        ...
        _processSummary: function(e) {
            ...
            n.empty();
            if (!e) return;
            var r = e[t.get("pageSummaryField")],
